        ...
        <div class="container-fluid">
			...
			<?php
				...
				if($category!="Highlights")
				{
					...
					while ($number > $i) 
					{
						...
						?>
							...
							<a href="http://bigbandroid.altervista.org/Assistance Service.php?title=<?echo $title;?>">
							<div class="col-lg-4 col-sm-6">
								<div class="portfolio-box">
									<center>
										<img src="img/allAssistanceServicesCategories/<?echo $category;?>/<?echo $title ?>.png" class="img-responsive" alt="">
									</center>
				...
				{//I print only the promo device
					...
					while ($number > $i) 
					{
						$highlights=mysql_result($result,$i,"Highlights");
						if($highlights==1)
						{
							$title = mysql_result($result,$i,"Title");
							$description=mysql_result($result,$i,"Description");
